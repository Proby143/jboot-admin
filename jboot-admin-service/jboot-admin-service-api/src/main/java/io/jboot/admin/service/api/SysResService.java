...
public interface SysResService  {
     ...
     * @return
     */
    public SysRes findById(Object id);
     ...
     * @return
     */
    public boolean delete(SysRes model);
     ...
     * @return
     */
    public boolean save(SysRes model);
     ...
     * @return
     */
    public boolean saveOrUpdate(SysRes model);
     ...
     * @return
     */
    public boolean update(SysRes model);
