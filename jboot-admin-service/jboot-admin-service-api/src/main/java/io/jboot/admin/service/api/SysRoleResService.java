...
public interface SysRoleResService  {
     ...
     * @return
     */
    public SysRoleRes findById(Object id);
     ...
     * @return
     */
    public boolean delete(SysRoleRes model);
     ...
     * @return
     */
    public boolean save(SysRoleRes model);
     ...
     * @return
     */
    public boolean saveOrUpdate(SysRoleRes model);
     ...
     * @return
     */
    public boolean update(SysRoleRes model);
